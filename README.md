    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom" style="width: 980px;">
        ...
        <div class="w3-container">
          ...
          <h2 class="w3-text-teal"><i class="fa fa- fa-fw w3-margin-right"></i> - <span class="w3-tag w3-teal w3-round">this program alows the user to place blocks, the program then rembers wher those blocks were placed,
          and alows you to stack the blocks on top of eachother </span></h2>
